import { POPUP_DISPLAY_DURATION_IN_MS, POPUP_FADE_ANIMATION_DURATION_IN_MS } from "../config.js";
...
export function displayError(message) {
  ...
  setTimeout(() => {
    ...
    }, POPUP_FADE_ANIMATION_DURATION_IN_MS); // wait for the transition to complete (1 second)
