...
import { createC2pa, createL2ManifestStore, generateVerifyUrl } from './c2pa/dist/c2pa.esm.js';
...
/**
 * Validates a C2PA image and returns its manifest, viewMoreUrl, and validationStatus.
 *
 * @async
 * @param {Object} image - The image to validate.
 * @returns {Promise<Object|null>} An object containing the manifest, viewMoreUrl, and
...
const validateC2pa = async (image) => {
  ...
  try {
    ...
    debug('[sandbox] Error reading image:', err);
    return null;
  }
};
