...
* @returns {Promise<any>}
*/
export function getManifestStoreFromArrayBuffer(buf, mime_type) {
...
* @returns {Promise<any>}
*/
export function getManifestStoreFromManifestAndAsset(manifest_buffer, asset_buffer, mime_type) {
    const ptr0 = passStringToWasm0(mime_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('toolkit_bg.wasm', import.meta.url);
    }
    const imports = getImports();
