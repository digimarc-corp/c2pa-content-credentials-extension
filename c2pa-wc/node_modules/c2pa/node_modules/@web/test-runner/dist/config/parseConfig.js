...
async function parseConfig(config, cliArgs = {}) {
    ...
    finalConfig.plugins.unshift(plugins_1.setViewportPlugin(), plugins_1.emulateMediaPlugin(), plugins_1.setUserAgentPlugin(), plugins_1.filePlugin(), plugins_1.sendKeysPlugin(), plugins_1.sendMousePlugin(), plugins_1.snapshotPlugin({ updateSnapshots: !!cliArgs.updateSnapshots }));
